...
public class Integer {
     ...
     * @return length of resulting serialized number including sign (number of bytes) 
     */
    public short toByteArrayUnsigned(byte[] outBuffer, short outBufferOffset) {
        //Store magnitude
        Util.arrayCopyNonAtomic(this.getMagnitude_b(), (short) 0, outBuffer, outBufferOffset, this.getSize());
        return (short) this.getSize();
    }
