...
public class Tx {
    ...
    public static short SCRIPTHASH_SIZE = 32; // todo add 3 0x22
    public static byte[] SCRIPTHASH_SIZE_BYTE = new byte[]{0x20};
    ...
    public static void init() {
        ...
        //2) to local value
        //3) to local script size
        //4) to local script hash
        ...
        //5) to remote value
        //6) to remote script size
        //7) to remote agent script hash
        ...
        //8) to htlc value
        //9) to htlc script size
        //10) to htlc script hash
        
        //11) lock time + sighash all
        txRest = new byte[]{
